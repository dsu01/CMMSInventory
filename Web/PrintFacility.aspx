<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PrintFacility.aspx.cs" Inherits="PrintFacility" %>
...
<head runat="server">
	...
	<body>
	   ...
	   <asp:Panel ID="pnlEletrical" runat="server" Visible="false">
	...
	<asp:Panel ID="pnlMechanical" runat="server" Visible="false">	
		    <table cellspacing="0" cellpadding="3" width="635" border="0">   
