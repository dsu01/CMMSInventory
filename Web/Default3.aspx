                                    ...
                                    <AlternatingItemTemplate> 
                                      <tr style="background-color:#EFEFEF"> 
                                            <td width="10%">
                                                 ...
                                                 <asp:HyperLink ID="HyperLink1" runat="Server" Text='<%# Eval("Facility#") %>'  />  
                                              
                                               <asp:Label runat="server" Visible="false" ID="Label1" Text='<%#Eval("FacilityGroup")%>'></asp:Label>
                                               <asp:Label runat="server" Visible="false" ID="Label2" Text='<%#Eval("ID")%>'></asp:Label>
                                           </td> 
                                           <td><asp:Label runat="server" ID="Label3"><%#Eval("FacilityID")%></asp:Label></td>   
                                           <td><asp:Label runat="server" ID="Label4"><%#Eval("FacilityFunction")%></asp:Label></td> 
                                           <td><asp:Label runat="server" ID="Label5"><%#Eval("FacilitySystem")%></asp:Label></td> 
                                           <td><asp:Label runat="server" ID="Label6"><%#Eval("Building")%></asp:Label></td>  
                                           <td><asp:Label runat="server" ID="Label7"><%#Eval("location")%></asp:Label></td> 
                                           <td><asp:Label runat="server" ID="Label8"><%#Eval("TotalEquipments")%></asp:Label></td>  
                                            <td>
                                            <asp:Hyperlink id="Hyperlink2" runat="server" Text='Action'                                    
                                                    NavigateUrl='<%# String.Format("Admin/AdminAction.aspx?FacId={0}", Eval("ID")) %>'>
                                                </asp:Hyperlink>
                                           </td>
                                          </tr> 
